...
const NotesLists = () => {
    ...
    return(
        <div className="bg-gray-200 min-h-screen p-6">
            ...
            <Link to="/create">
                <button className="bg-green-500 text-white px-3 py-1 rounded hover:bg-green-700"> Create Note</button>
            </Link>
            <button onClick={logoutUser} className="bg-green-500 text-white px-3 py-1 rounded hover:bg-green-700">Logout</button>
            </div>
            </div>
